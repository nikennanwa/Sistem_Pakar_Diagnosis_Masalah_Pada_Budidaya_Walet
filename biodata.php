    ...
    <form action="?m=daftar" method="post">
        <div class="form-group" style="width: 400px">
            ...
            <p>
                ...
                name="nama" value="<?= isset($_GET['q']) ? htmlspecialchars($_GET['q']) : '' ?>" />
            </p>
        </div>
        <div class="form-group" style="width: 400px">
            <p style="color: #fff;" align="left"><b>No. Hp</b> <span class="text-danger">*</span></p>
            <input style="color: #000;" class="form-control" type="number" name="no_hp" required placeholder="Masukkan Nomor Handphone" />
        </div>

        <div class="form-group" style="width: 400px">
            <p style="color: #fff;" align="left"><b>Jenis Kelamin</b> <span class="text-danger">*</span></p>
            <p align="left">
                <input required type="radio" name="jk" value="Laki - Laki"><b> Laki - Laki </b>
                <input required type="radio" name="jk" value="Perempuan"><b> Perempuan</b>
            </p>
        </div>
        ...
        <div class="form-group" style="width: 400px">
            ...
            <input type="text" class="form-control" readonly name="tgl" 
                value="<?php 
                    date_default_timezone_set('Asia/Jakarta');
                    echo date('H:i') . ' · ' . TanggalIndonesia(date('Y-m-d')); 
                ?>" 
                id="jam" />
        </div>
        <br>
